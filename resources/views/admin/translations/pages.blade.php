        ...
        <div class="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600">{{ $pages->where('is_translated', true)->count() ?? 0 }}</p>
                </div>
                <div class="w-12 h-12 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center">
        ...
        <div class="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-orange-600">{{ $pages->where('is_translated', false)->count() ?? 0 }}</p>
                </div>
                    ...
                    @forelse($pages ?? [] as $page)
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-sm text-gray-500">{{ Str::limit($page->title_en ?? '', 50) }}</div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900">{{ Str::limit(strip_tags($page->content), 80) }}</div>
                                <div class="text-sm text-gray-500">{{ Str::limit(strip_tags($page->content_en ?? ''), 80) }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($page->is_translated ?? false)
