...
@section('page-title', 'تعديل ترجمة القصة')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-3xl p-6 lg:p-8 shadow-sm border border-gray-100">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">تعديل ترجمة القصة</h1>
                <p class="text-gray-600 mt-2">تحديث ترجمة قصة: {{ $story->title }}</p>
                ...
                <nav class="flex items-center space-x-2 {{ app()->getLocale() === 'ar' ? 'space-x-reverse' : '' }} mt-4">
                    ...
                    <i class="fas fa-chevron-{{ app()->getLocale() === 'ar' ? 'left' : 'right' }} text-gray-400 text-xs"></i>
                    <a href="{{ route('admin.translations.stories') }}" class="text-gray-500 hover:text-gray-700 transition-colors duration-200">
                        القصص
                    </a>
                    <i class="fas fa-chevron-{{ app()->getLocale() === 'ar' ? 'left' : 'right' }} text-gray-400 text-xs"></i>
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.translations.stories') }}" class="inline-flex items-center justify-center px-4 py-2.5 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-2xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <form action="{{ route('admin.translations.stories.update', $story->id) }}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea rows="4" disabled
                                      class="block w-full px-4 py-3 border-2 border-gray-200 rounded-2xl bg-gray-50 text-gray-600 resize-none">{{ $story->content }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   required
                                   value="{{ old('translations.en.title', $story->translation('en')?->title) }}"
                        ...
                        <div>
                            ...
                            <textarea id="translations.en.content" 
                                      ...
                                      placeholder="أدخل المحتوى باللغة الإنجليزية">{{ old('translations.en.content', $story->translation('en')?->content) }}</textarea>
