                    ...
                    @forelse($testimonials ?? [] as $testimonial)
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-sm text-gray-500">{{ $testimonial->translation('en')?->name }}</div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900">{{ Str::limit($testimonial->content, 80) }}</div>
                                <div class="text-sm text-gray-500">{{ Str::limit($testimonial->translation('en')?->content, 80) }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    @for($i = 1; $i <= 5; $i++)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($testimonial->translations_count > 0)
